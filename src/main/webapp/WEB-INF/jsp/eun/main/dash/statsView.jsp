...
<div class="content flex flexCol">
	...
	<div class="ifrDiv">
		<iframe id="ifrm1" src="http://kosis.kr/statHtml/statHtml.do?orgId=634&tblId=DT_63401_A000011&lang_mode=ko&vw_cd=MT_ZTITLE&list_id=210_210A_634_63401_A&conn_path=I4" width="1000px", height=200px>
		  <p>사용 중인 브라우저는 iframe을 지원하지 않습니다.</p>
		</iframe>
	</div>
